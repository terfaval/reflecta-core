...
THEME_PATTERNS: Dict[str, Iterable[str]] = {
    ...
    "deepening": [
        ...
        r"testemben",
        r"k[ée]p jelent meg",
        r"t[úu]l sokat nyelek",
        r"nem tudom, hol vagyok ebben",
        r"valami m[ée]lyebb mozog bennem",
    ],
    "integrative": [
        r"egyr[ée]szt",
        r"m[áa]sr[ée]szt",
        ...
        r"[öo]ssze[ée]rnek bennem.*(r[ée]gi mint[áa]k|helyzetek|[ée]rz[ée]sek)",
    ],
    "transformative": [
        r"[úu]gy d[öo]nt[öo]ttem.*m[áa]sk[ée]pp",
        r"[úu]j n[ée]z[őo]pont",
        r"[áa]tfordult bennem",
        r"nem a r[ée]gi.*[ée]n.*vagyok",
        r"[úu]gy l[áa]tom.*nem ugyanaz.*j[áa]tszma",
        r"[úu]j szemmel n[ée]zek.*(helyzet|kapcsolat|probl[ée]ma)",
    ],
    "concluding": [
        r"megtanultam",
        r"lez[áa]rult",
    ...
    "contemplative": [
        ...
        r"n[ée]ha el[ée]g.*csendben maradni",
        r"nem kell.*v[áa]lasz.*most",
        r"el[ée]g.*jelen.*lenni.*(v[áa]laszok n[ée]lk[üu]l)?",
    ],
    "affirmative": [
        r"m[áa]r meg[ée]ltem ezt",
        r"k[ée]pes vagyok r[áa]",
        r"eml[ée]keztet arra, amikor er[őo]s voltam",
        r"most m[áa]r.*t[öo]r[őo]d[ée]s.*bennem.*(harag helyett|ahelyett hogy harag lenne)",
    ],
    "reflective_mirror": [
