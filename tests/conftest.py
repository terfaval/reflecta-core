...
if httpx.__version__ >= "0.28":
    ...
    @wraps(original_init)
    def patched_init(self, app, base_url="http://testserver", raise_server_exceptions=True, root_path="", backend="asyncio", backend_options=None, cookies=None, headers=None):
        self.async_backend = starlette.testclient._AsyncBackend(backend=backend, backend_options=backend_options or {})
